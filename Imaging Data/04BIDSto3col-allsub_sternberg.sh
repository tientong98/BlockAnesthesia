...
for n in 0 ; do
for event in RT CT PT NT ; do

sh /Shared/rblock_mr/code/BIDSto3col-singlesub.sh -e ${event} $bidsdir/sub-${subj[$n]}/func/sub-${subj[$n]}_task-sternberg_events.tsv $bidsdir/sub-${subj[$n]}/func/sub-${subj[$n]}_task-sternberg_events-${event}
